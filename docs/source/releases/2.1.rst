...
Version 2.1.1 adopts the renamed GKM metaschema processor and its
abstract-class convention, and opens the abstract variation and location
classes as extension points for third-party implementations. Concrete-class
representations and computed identifiers are unchanged. (@larrybabb in
...
##################
  ...
  * adopts the renamed ``ga4gh.gkm.metaschema`` processor and its
    ...
    false``.
  * bumps the gkm-core submodule to ``1.2.1-ballot.2026-09`` and retokenizes
    the schema identity to ``2.1.1-ballot.2026-09``; the upstream gkm-core
    changes do not alter any class inherited or embedded by VRS.
