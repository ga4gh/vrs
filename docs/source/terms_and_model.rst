...
* Discrete: Variation that cannot be decomposed to simpler concepts
  and still be regarded as variation. A simple sequence change is an
  example of Discrete Variation.
* Aggregate: Variation that represents a collection of other kinds of
  variation.  A Haplotype, as a collection of Alleles, is an example
  of Aggregate Variation.
...
.. list-table::
   ...
   * - members
     - :ref:`Discrete_Variation`\[] or :ref:`CURIE`\[]
     - 0..*
